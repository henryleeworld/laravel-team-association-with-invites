    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                                        ...
                                        @if(auth()->user()->isOwnerOfTeam($team))
                                            @if(auth()->user()->getKey() !== $user->getKey())
                                                <form style="display: inline-block;" action="{{route('teams.members.destroy', [$team, $user])}}" method="post">
                                                    ...
                                                    <button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> {{ trans('frontend.teams.members.content.delete') }}</button>
                                                </form>
                                            @endif
                                        @endif
                                    </td>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">{{ trans('frontend.teams.members.content.pending_invitations') }}</div>
                    <div class="panel-body">
                        <table class="table table-striped">
                            <thead>
                            <tr>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">{{ trans('frontend.teams.members.content.invite_to_team') }}"{{$team->name}}"</div>
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-btn fa-envelope-o"></i>{{ trans('frontend.teams.members.content.invite_to_team') }}
                                    </button>
                                </div>
                            </div>
                        </form>
